  ...
  const apiDemos = [
    {
      ...
      description: 'AI identifies high-opportunity content topics using competitor analysis',
    ...
    },
    {
      ...
      description: 'Generate 30-day content strategy with performance predictions',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">AI-powered content automation</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm border border-gray-200">
                ...
                <span className={`text-sm font-semibold ${getStatusText()}`}>{apiStatus}</span>
              </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-md rounded-full px-4 py-2 mb-6">
              ...
              <span className="font-semibold">TiDB AgentX Hackathon 2025 Winner</span>
            </div>
            ...
            <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto">
              The first AI system that autonomously manages your entire content strategy - from research to publication
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience our agentic AI in action. Each endpoint showcases sophisticated multi-step workflows that go far beyond simple Q&A.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {apiDemos.map((demo, index) => {
            ...
            return (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${demo.gradient} opacity-5 group-hover:opacity-10 transition-opacity`}></div>
                <div className="relative p-8">
                  <div className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br ${demo.gradient} rounded-xl mb-6 group-hover:scale-110 transition-transform`}>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200/50 mb-8 overflow-hidden">
          ...
          <div className="p-8">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200/50 p-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                    {[
                      { step: "1. Data Ingestion", desc: "Collect & embed content" },
                      { step: "2. Vector Search", desc: "Find similar patterns" },
                      { step: "3. AI Analysis", desc: "Identify opportunities" },
                      { step: "4. Strategy Generation", desc: "Create content plans" },
            ...
            {activeTab === 'gaps' && (
              <div className="text-center space-y-6">
                <div className="max-w-2xl mx-auto">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">🎯 Content Gap Analysis</h3>
                  <p className="text-gray-600 mb-8">
                    Our AI analyzes competitor content using vector similarity search to identify high-opportunity topics you're missing.
                  </p>
                </div>
                <a 
                ...
                >
                  ...
                  <span className="font-semibold">Run Content Gap Analysis</span>
            ...
            {activeTab === 'calendar' && (
              <div className="text-center space-y-6">
                <div className="max-w-2xl mx-auto">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">📅 AI Content Calendar</h3>
                  <p className="text-gray-600 mb-8">
                    Generate comprehensive content strategies with performance predictions, optimal timing, and detailed briefs.
                  </p>
                </div>
                <a 
                ...
                >
                  ...
                  <span className="font-semibold">Generate 30-Day Calendar</span>
                  <ExternalLink className="w-4 h-4" />
                </a>
              </div>
            )}
            ...
            {activeTab === 'automation' && (
              <div className="space-y-8">
                <div className="text-center max-w-2xl mx-auto">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">⚡ Automation Dashboard</h3>
                  <p className="text-gray-600 mb-8">
                    End-to-end workflow automation with real-time monitoring and performance optimization.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    { title: "6 Posts Scheduled", desc: "Next: Today at 9:00 AM", icon: CheckCircle, color: "green" },
                    { title: "18.5K Projected Reach", desc: "This week's content", icon: Activity, color: "blue" },
                    { title: "15 Hours Saved", desc: "This month", icon: Zap, color: "purple" }
                  ].map((item, index) => {
                    ...
                    return (
                      <div key={index} className={`text-center p-6 ${colors[item.color].bg} rounded-xl border ${colors[item.color].border}`}>
                        <Icon className={`mx-auto ${colors[item.color].icon} mb-3`} size={32} />
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-black text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-6">
            <h3 className="text-2xl font-bold mb-2">🏆 TiDB AgentX Hackathon 2025</h3>
            <p className="text-gray-300 text-lg">Contentr: Agentic AI for Real-World Content Automation</p>
          </div>
